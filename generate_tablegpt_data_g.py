...
if __name__ == "__main__":
    ...
    task_data_dir = os.path.join(args.source_dir, args.task)# 获取数据集路径和任务名
    train_data_dir = os.path.join(task_data_dir, "train")# 构建训练数据目录的路径，将任务数据目录和 "train" 拼接起来；得到的是路径
